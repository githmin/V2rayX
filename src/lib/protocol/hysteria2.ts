...
export class Hysteria2 extends Protocol {
  ...
  private parseHysteria2(arg: string): Hysteria2Type {
    ...
    const hysteria2Config: Hysteria2Type = {
      ...
      recv_window_conn: parseInt(queryParams.get('recv_window_conn') || '0', 10),
      recv_window: parseInt(queryParams.get('recv_window') || '0', 10),
      ...
      hop_interval: parseInt(queryParams.get('hop_interval') || '0', 10),
