...
import { queryInboundsSettings, updateInbounds } from '~/app/api';
...
const InboudSettigTabContent = (props: {
  ...
  const onSubmit: SubmitHandler<InboundSchema> = async (data) => {
    try {
      ...
      toast.success('Inbounds have been updated successfully');
    } catch (e) {
      toast.error(`${e}`);
    }
  };
            ...
            <Controller
              ...
              render={({
                ...
                <Input
                  ...
                  description="Please make sure the port is not in use and unique"
                  ref={ref}
                  name={name}
