...
import { NavLink, Navigate, Route, Routes, Outlet, useNavigate } from 'react-router-dom';
...
// import { createAuthTable } from '~/app/api';
      ...
      <Route
        ...
        element={
          <div className="flex h-screen flex-row">
            ...
            <div className="mx-auto my-auto flex-grow"></div>
          </div>
        }
      />
    </Routes>
